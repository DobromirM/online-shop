	...
	<div class="main-container">
		...
		<div class="content">
			...
			<div class="search">
				...
				<form method="Get" name="search" action="cds.jsp" >
			...
			<%
			 ...
			 %>
				 	<sql:query var="result">
    					SELECT * FROM inventory WHERE item_group = (SELECT group_code FROM inventory_group WHERE group_name = 'Music');
    				</sql:query> 
    		 <%
   				}
   				else
   			 ...
   			 %>
   					<sql:query var="result">
    					SELECT * FROM inventory WHERE item_group = (SELECT group_code FROM inventory_group WHERE group_name = 'Music') AND item_description LIKE "%<%=request.getParameter("search-bar")%>%";
    				</sql:query> 
    		<%
   				}
   			%>
